...
function createData(Lifter_Model, Power_Source, wheel_type,Counterweight) {
  return {
    Lifter_Model,
    Power_Source,
    wheel_type,
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="right"  >{row.Power_Source}</TableCell>
                          <TableCell align="right"  >{row.wheel_type}</TableCell>
                          <TableCell align="right"  >{row.Counterweight}</TableCell>
